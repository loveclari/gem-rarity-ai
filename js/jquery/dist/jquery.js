...
document.addEventListener("DOMContentLoaded", function () {
	var weChatElement = document.querySelector(".we-chat");
	var tooltip = weChatElement.querySelector("#tooltip910160");

	weChatElement.addEventListener("mouseenter", function () {
		tooltip.style.display = "block";
	});

	weChatElement.addEventListener("mouseleave", function () {
		tooltip.style.display = "none";
	});

	document.addEventListener("click", function (event) {
		if (!weChatElement.contains(event.target)) {
			tooltip.style.display = "none";
		}
	});
});
